...
$lang = array(
		"fedex_title"								=> "FedEx Live Rates",
		'fedex_overview'							=> '<p>This shipping plugin requires PHP5 or greater, and SOAP installed and configured on your server.</p>
		...
		"fedex_ground_home_delivery"				=> 'Ground Home Delivery',
		"fedex_ground"								=> 'Ground', 	
		"fedex_hubid"						        => 'SmartPost HubID (You must have smart post turned on in your FedEx account)',
		...
		"fedex_smart_post_header"					=> 'SmartPost Information',	
		"fedex_sp_ancillary_services"				=> 'SmartPost Ancillary Services',		
		"fedex_sp_indicia"						    => 'SmartPost Indicia',
		...
		"fedex_valid_international_values"			=> '--- Valid International Values ---',
		"fedex_valid_domestic_values"				=> '--- Valid Domestic Values ---',
