...
$lang = [
        ...
        'fedex_overview' => '
            <p>This shipping plugin requires  CartThrob 6+, PHP 7.4+, and the PHP Soap module.</p>
            ...
            <h3 style="display:block">Dimensional Weight Warning</h3>
            <p>Length + Width + Height values are <strong>required</strong> for shipping quotes using Live Rates plugins. Some shipping methods such as overnight, next-day, and two-day shipping methods may only calculate costs by box dimensions rather than standard weights. Please consult documentation provided by your shipping company, or your shipping representative for more information.</p>
        ',
